...
最近在咸鱼上淘了两个二手网关，价格挺便宜的，到手先拍几张照片给大家看看。

这种二手网关如果能刷机玩就赚了，比如刷 OpenWrt、Tasmota、ESPHome 之类的。有没有懂行的坛友帮忙看看？
...
1. 这两个网关主控是什么芯片？有没有对应的开源固件？
2. 如果需要拆机看芯片型号，拆机难度大不大？有没有卡扣位置需要注意？
3. 如果刷机成功，一般能玩什么？MQTT 网关？还是可以直接当智能家居中枢？
